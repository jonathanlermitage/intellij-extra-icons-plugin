...
* rework Backup, Build, Codefresh, Deptective, Glowroot, Jar/Dar, JVM config, JSBeautify, JSHint, Kibana, Lerna, Logstash, Muse, MySQL Workbench, Nox, PDF, Roadmap, Stylus, To-Do, Tox and Zalando Zappr icons in order to make them compatible with Gateway.
