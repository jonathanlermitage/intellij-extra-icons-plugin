...
plugins {
    id("java")
    id("idea")
    id("org.jetbrains.intellij") version "0.6.1" // https://github.com/JetBrains/gradle-intellij-plugin
    id("com.github.ben-manes.versions") version "0.34.0" // https://github.com/ben-manes/gradle-versions-plugin
}
